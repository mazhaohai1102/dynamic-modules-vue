 ...
 * @LastEditors: martin
 * @LastEditTime: 2021-12-17 10:50:31
 */
export default [
  {
    children: [
      {
        ...
        children: [{
          path: 'nestdetail',
          name: 'Nestdetail',
          component: () => import(/* webpackChunkName: "nestdetail" */'./pages/Nestdetail'),
        }]
      },
      {
        path: 'detail/subdetail',
        name: 'Subdetail',
        component: () => import(/* webpackChunkName: "subdetail" */'./pages/Subdetail'),
      }
    ]
  }
];